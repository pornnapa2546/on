...
<div class="sidebar">
  ...
  <div class="nav-menu">
    <div class="nav-item" onclick="location.href='admin-dashboard.php'"><i class="fas fa-chart-pie"></i> Dashboard</div>
    <div class="nav-item" onclick="location.href='admin.php'"><i class="fas fa-shopping-cart"></i> Orders</div>
    <div class="nav-item" onclick="location.href='orders-by-day.php'"><i class="fas fa-calendar-day"></i> Orders by Day</div>
    <div class="nav-item" onclick="location.href='orders-by-month.php'"><i class="fas fa-calendar-alt"></i> Orders by Month</div>
    <div class="nav-item active"><i class="fas fa-calendar"></i> Orders by Year</div>
    <div class="nav-item" onclick="location.href='admin-menu.php'"><i class="fas fa-store"></i> Manage</div>
    <div class="nav-item" onclick="location.href='admin-settings.php'"><i class="fas fa-cog"></i> Settings</div>
    <div class="nav-item" onclick="location.href='logout.php'"><i class="fas fa-sign-out-alt"></i> Logout</div>
  </div>
</div>
...
<?php endwhile; else: ?>
<tr><td colspan="6" style="text-align:center;color:#999">ไม่มีออเดอร์ในปีที่เลือก</td></tr>
<?php endif; ?>
</tbody>
</table>
</div>
