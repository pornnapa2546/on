...
<section class="categories">
    <div class="container">
        <h2 class="text-center">รวมเมนู (All Menu)</h2>
...
<section class="food-menu">
    <div class="container">
        <h2 class="text-center text-white">เมนูทั้งหมด (All Drinks)</h2>
        <div class="heading-border"></div>
...
<?php while ($m = $menus->fetch_assoc()): ?>
            <div class="food-menu-box">
                ...
                <div class="food-menu-desc">
                    ...
                    <p class="food-detail">
                        ประเภท: <?= htmlspecialchars($m['category_name'] ?? '-') ?>
                    </p>
