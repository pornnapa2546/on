...
<section class="categories">
    <div class="container">
        <h2 class="text-center">กาแฟ (Coffee)</h2>
...
<section class="food-menu">
    <div class="container">
        <h2 class="text-center text-white">เมนูกาแฟ (Coffee Menu)</h2>
        <div class="heading-border"></div>
...
if ($coffee->num_rows == 0):
?>
    <p class="text-center">ยังไม่มีเมนูกาแฟ</p>
<?php endif; ?>

<?php while ($m = $coffee->fetch_assoc()): ?>
...
<div class="drink-options">
  ...
  <div class="option-group">
    ...
    <input type="hidden" class="drink-sweet">
  </div>
...
document.querySelectorAll(".food-menu-box").forEach(box => {
  ...
  // TEMP
  box.querySelectorAll(".option-buttons[data-type='temp'] button")
    .forEach(btn => {
  ...
  // SWEET
  box.querySelectorAll(".option-buttons[data-type='sweet'] button")
    .forEach(btn => {
      btn.addEventListener("click", () => {
