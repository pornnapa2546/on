...
<div class="sidebar">
  ...
  <div class="nav-menu">
    ...
    <div class="nav-item" onclick="location.href='orders-by-month.php?view=month'">
      <i class="fas fa-calendar-alt"></i> Orders by Month
    </div>

    <div class="nav-item" onclick="location.href='orders-by-year.php?view=year'">
...
<form method="get" style="margin-bottom:20px;">
  ...
  <button class="btn btn-outline" type="submit">ดูออเดอร์</button>
</form>
